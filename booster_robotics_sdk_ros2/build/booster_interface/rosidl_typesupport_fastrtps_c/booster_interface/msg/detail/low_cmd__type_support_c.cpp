...
#include "booster_interface/msg/detail/low_cmd__rosidl_typesupport_fastrtps_c.h"
...
#include "booster_interface/msg/detail/motor_cmd__functions.h"  // motor_cmd

// forward declare type support functions
size_t get_serialized_size_booster_interface__msg__MotorCmd(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_booster_interface__msg__MotorCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, booster_interface, msg, MotorCmd)();


using _LowCmd__ros_msg_type = booster_interface__msg__LowCmd;
  ...
  // Field name: motor_cmd
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, booster_interface, msg, MotorCmd
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: motor_cmd
  {
    ...
    if (!booster_interface__msg__MotorCmd__Sequence__init(&ros_message->motor_cmd, size)) {
...
size_t get_serialized_size_booster_interface__msg__LowCmd(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowCmd__ros_msg_type * ros_message = static_cast<const _LowCmd__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_booster_interface__msg__MotorCmd(
...
static uint32_t _LowCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_booster_interface__msg__LowCmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_booster_interface
size_t max_serialized_size_booster_interface__msg__LowCmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_booster_interface__msg__MotorCmd(
  ...
  if (is_plain) {
    ...
    using DataType = booster_interface__msg__LowCmd;
    is_plain =
      (
...
static size_t _LowCmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_booster_interface__msg__LowCmd(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, booster_interface, msg, LowCmd)() {
