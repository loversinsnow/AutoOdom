...
#include "booster_interface/msg/detail/low_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const booster_interface::msg::MotorCmd &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  booster_interface::msg::MotorCmd &);
...
cdr_serialize(
  const booster_interface::msg::LowCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  booster_interface::msg::LowCmd & ros_message)
{
  // Member: cmd_type
  cdr >> ros_message.cmd_type;
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_cmd
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        booster_interface::msg::typesupport_fastrtps_cpp::max_serialized_size_MotorCmd(
  ...
  if (is_plain) {
    ...
    using DataType = booster_interface::msg::LowCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const booster_interface::msg::LowCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<booster_interface::msg::LowCmd *>(
    untyped_ros_message);
...
get_message_type_support_handle<booster_interface::msg::LowCmd>()
{
  return &booster_interface::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, booster_interface, msg, LowCmd)() {
  return &booster_interface::msg::typesupport_fastrtps_cpp::_LowCmd__handle;
}
