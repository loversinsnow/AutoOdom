...
#include "booster_interface/msg/detail/motor_cmd__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const booster_interface::msg::MotorCmd & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  booster_interface::msg::MotorCmd & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = booster_interface::msg::MotorCmd;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const booster_interface::msg::MotorCmd *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<booster_interface::msg::MotorCmd *>(
    untyped_ros_message);
...
get_message_type_support_handle<booster_interface::msg::MotorCmd>()
{
  return &booster_interface::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, booster_interface, msg, MotorCmd)() {
  return &booster_interface::msg::typesupport_fastrtps_cpp::_MotorCmd__handle;
}
